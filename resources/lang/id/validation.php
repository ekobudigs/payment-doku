...
return [
    ...
    */
    ...
    'required_if' => 'Isian :attribute wajib diisi.',
    ...
    */
    ...
    'attributes' => [
        ...
        'allow_couple_photos' => 'foto pasangan',
        'allow_galleries' => 'galeri',
        'allow_videos' => 'video',
        'allow_google_maps' => 'google maps',
        'allow_countdown' => 'countdown',
        'allow_backsound' => 'musik latar',
        'allow_guest_book' => 'buku tamu',
        'allow_guest_target' => 'nama tamu',
        'allow_rsvp' => 'rsvp',
        'allow_gift' => 'gift',
        'max_galleries' => 'batas maksimal galeri',
        'max_videos' => 'batas maksimal video',
    ],
];
